...
public interface Constants {
    ...
    public interface QueryProcessorInfo {
        ...
        String QP_SQLDATE_FORMAT = "sqldate_format";
        String QP_SQLDATE_FORMAT_DEFAULT = "yyyy-MM-dd";
        String QP_SQLDATE_FORMAT_PROP = PREFIX + QP_SQLDATE_FORMAT;
        String FULL_QP_SQLDATE_FORMAT_PROP = SPACE_CONFIG_PREFIX + QP_SQLDATE_FORMAT_PROP;

        String QP_SQLTIME_FORMAT = "sqltime_format";
        String QP_SQLTIME_FORMAT_DEFAULT = "HH:mm:ss";
        ...
        String QP_LOCALDATETIME_FORMAT = "localdatetime_format";
        String QP_LOCALDATETIME_FORMAT_DEFAULT = "yyyy-MM-dd HH:mm:ss";
        String QP_LOCALDATETIME_FORMAT_PROP = PREFIX + QP_LOCALDATETIME_FORMAT;
        String FULL_QP_LOCALDATETIME_FORMAT_PROP = SPACE_CONFIG_PREFIX + QP_LOCALDATETIME_FORMAT_PROP;

        String QP_LOCALTIME_FORMAT = "localtime_format";
        String QP_LOCALTIME_FORMAT_DEFAULT = "HH:mm:ss";
        String QP_LOCALTIME_FORMAT_PROP = PREFIX + QP_LOCALTIME_FORMAT;
        String FULL_QP_LOCALTIME_FORMAT_PROP = SPACE_CONFIG_PREFIX + QP_LOCALTIME_FORMAT_PROP;

        String QP_LOCALDATE_FORMAT = "localdate_format";
        String QP_LOCALDATE_FORMAT_DEFAULT = "yyyy-MM-dd";
        String QP_LOCALDATE_FORMAT_PROP = PREFIX + QP_LOCALDATE_FORMAT;
        String FULL_QP_LOCALDATE_FORMAT_PROP = SPACE_CONFIG_PREFIX + QP_LOCALDATE_FORMAT_PROP;

        String QP_INSTANT_FORMAT = "instant_format";
        String QP_INSTANT_FORMAT_DEFAULT = "yyyy-MM-dd HH:mm:ss.SSS";
        String QP_INSTANT_FORMAT_PROP = PREFIX + QP_INSTANT_FORMAT;
        String FULL_QP_INSTANT_FORMAT_PROP = SPACE_CONFIG_PREFIX + QP_INSTANT_FORMAT_PROP;
    }
    ...
    public interface Engine {
        ...
        String ENGINE_BLOBSTORE_ROCKSDB_ALLOW_DUPLICATE_UIDS = "engine.blobstore.rocksdb.allow_duplicate_uids";
    ...
    public interface CacheManager {
        ...
        String CACHE_MANAGER_BLOBSTORE_CACHE_FILTER_QUERIES_PROP = "engine.blobstore_cache_filter_queries";
        String FULL_CACHE_MANAGER_BLOBSTORE_CACHE_FILTER_QUERIES_PROP = SPACE_CONFIG_PREFIX + CACHE_MANAGER_BLOBSTORE_CACHE_FILTER_QUERIES_PROP;
    ...
    public interface DirectPersistency {
        ...
        public interface ZOOKEEPER {
            ...
            String ZOOKEEPER_CLIENT_CLASS_NAME = "org.openspaces.zookeeper.chunks_map.ZookeeperClientImpl";
        }
    }
    ...
    public interface TieredStorage {
        ...
        String AUTO_GENERATE_SLA_PROP = "pu.autogenerated-instance-sla";
    ...
    public interface Scale{
        String SCALE_OUT_INTERVAL = "com.gs.manager.scale_out.interval";
        String SCALE_OUT_INTERVAL_DEFAULT = "2000";
    }
}
